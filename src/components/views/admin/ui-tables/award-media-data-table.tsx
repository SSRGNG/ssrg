...
type MediaType = AllAwardMedia[number];
type Props = React.ComponentPropsWithoutRef<"div"> & {
  media: AllAwardMedia;
  t_data?: T_Data;
};

function AwardMediaDataTable({ media, t_data, className, ...props }: Props) {
