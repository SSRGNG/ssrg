...
function Analytics({ teams, className, ...props }: Props) {
    ...
    >
      ...
      {/* <Card>
        ...
        <CardContent>
          ...
          <CardDescription className="text-xs text-muted-foreground">
            {analytics.activeTeams} active, {analytics.completedTeams} completed
          </CardDescription>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {analytics.totalMembers} total members across all teams
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            ${analytics.totalBudgetUsed.toLocaleString()} used (
            {analytics.totalBudget > 0
              ? (
                  (analytics.totalBudgetUsed / analytics.totalBudget) *
                  100
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {analytics.highPriorityTeams.length} high priority teams
          </p>
        </CardContent>
      </Card> */}
    </div>
